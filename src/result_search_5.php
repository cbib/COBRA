                                        ...
                                        foreach ($data as $key=>$value) {
                                            if ($key==="mapping_file"){
                                                foreach ($value as $values) {
                                                    ...
                                                    echo  '<button data-id="'.str_replace(".", "_", $values['Transcript ID']).'" data-sequence="'.$values['Transcript Sequence'].'" id="blast_button" type="button">Blast sequence</button>';
                                                    echo '  <center>
                                                                <div class="loading_'.str_replace(".", "_", $values['Transcript ID']).'" style="display: none">
                                                                    
                                                                
                                                                </div>
                                                            </center>
                                                        <div class="container animated fadeInDown">
                                                            <div class="content_test_'.str_replace(".", "_", $values['Transcript ID']).'">
