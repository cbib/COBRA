...
//            },
            ...
            tooltip: {
                ...
                //+this.series.name+ xp name
                    ...
                    s += '<ul><li><a target="_blank" href="./description/experiments.php?xp='+ x_name +'">'+clean_xp_name+'</a></li><li>'+'profile on Day '+ this.point.dpi +' post inoculation</li><li>Variety : '+ this.point.variety +'</li><li>infection type 1 : '+ this.point.first_condition +'</li><li>infection type 2 : '+ this.point.second_condition +'</li><li>logFC : '+ this.point.logFC +'</li></br>'
                         '</ul>';
