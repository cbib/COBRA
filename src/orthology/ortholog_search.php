            ...
            foreach ($gene_list_attributes as $attributes) {
                ...
                foreach ($attributes as $key => $value) {
                    if ($cpt==0){
                        ...
                        echo '<div style="cursor: pointer;" onclick="window.location=\'../result_search_5.php?organism='.str_replace(" ", "+", $species).'&search='.$attributes['search'].'\';" class="resultsbox" id="results">
